...
from app.api.endpoints import diagnostic, dashboard, plan, tutor, lesson, badges, mistakes, stats, referral, user_state, learning, telegram_webhook, events, user_data, speech, checkpoint, internal, beta
import os
...
@app.get("/api/version")
async def version():
    return {"version": VERSION, "release": "foundation-curriculum-quality", "commit": BUILD_COMMIT}
...
if os.path.exists(audio_path):
    app.mount("/media/audio", StaticFiles(directory=audio_path), name="lesson-audio")
